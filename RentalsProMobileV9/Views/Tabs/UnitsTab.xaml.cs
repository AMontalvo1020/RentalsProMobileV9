...
public partial class UnitsTab : ContentPage
{
	public UnitsTab()
	{
		InitializeComponent();
    ...
    public UnitsTab(INavigation navigation, PropertyDTO property) : this()
    {
        this.SetBindingContext(new UnitsTabViewModel(navigation, property));
    }
